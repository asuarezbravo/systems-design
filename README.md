...
- [9.2. How CDNs Work](./module_9/section_9_2.md)
- [9.3. CDN Benefits: Reducing Latency and Bandwidth](./module_9/section_9_3.md)
- [9.4. Static Content Caching via CDNs](./module_9/section_9_4.md)
- [9.5. Dynamic Content and Edge Computing](./module_9/section_9_5.md)

### [Module 10: Security and Design](./module_10/module_10_intro.md)
- [10.1. Secure Systems by Design](./module_10/section_10_1.md)
- [10.2. Authentication and Authorization Best Practices](./module_10/section_10_2.md)
- [10.3. Data Encryption and Secure Communication](./module_10/section_10_3.md)
- [10.4. Security in Distributed Systems](./module_10/section_10_4.md)
- [10.5. Common Security Threats and Mitigations (DDoS, Man-in-the-Middle, etc.)](./module_10/section_10_5.md)
